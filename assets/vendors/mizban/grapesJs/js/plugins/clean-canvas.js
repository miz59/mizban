class cleanConfirmation {
    ...
    show() {
        ...
        modalDialog.id = "modalDelete";
        modalDialog.className = 'gjs-mdl-content';
        ...
        noButton.className = 'on-primary-color border-style-none radius-all-small px-2 py-1 cursor-pointer';
        ...
        yesButton.className = 'on-primary-color border-style-none radius-all-small px-2 py-1 cursor-pointer';
